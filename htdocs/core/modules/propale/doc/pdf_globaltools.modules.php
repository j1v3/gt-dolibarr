...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_globaltools.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele globaltools
 */
...
/**
 *	Class to generate PDF proposal globaltools
 */
class pdf_globaltools extends ModelePDFPropales
{
    var $db;
    var $name;
    var $description;
        ...
        if ($conf->propal->dir_output)
        {
            ...
            if (file_exists($dir))
            {
                ...
                for ($i = 0 ; $i < $nblignes ; $i++)
                {
                    ...
                    // GT modif
                    $pos = strpos($up_excl_tax, ",") + 3;
                    $up_excl_tax = substr($up_excl_tax, 0, $pos);
